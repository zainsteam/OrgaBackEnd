    ...
    <div class="single-post">
        ...
        <?php
            ...
            if ( is_singular( 'attachment' ) ) {
                ...
                the_post_navigation( array(
                    'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'vw-mobile-app' ) . '</span> ' .
                        '<span class="screen-reader-text">' . __( 'Next post:', 'vw-mobile-app' ) . '</span> ' .
                        '<span class="post-title">%title</span>',
                    'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'vw-mobile-app' ) . '</span> ' .
